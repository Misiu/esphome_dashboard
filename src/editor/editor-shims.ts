...
export const CompletionItemKind = new Proxy(
  {} as typeof monaco.languages.CompletionItemKind,
  {
    get: (_, prop) =>
      monaco.languages.CompletionItemKind[
        prop as keyof typeof monaco.languages.CompletionItemKind
      ],
  },
);
export const CompletionItemInsertTextRule = new Proxy(
  {} as typeof monaco.languages.CompletionItemInsertTextRule,
  {
    get: (_, prop) =>
      monaco.languages.CompletionItemInsertTextRule[
        prop as keyof typeof monaco.languages.CompletionItemInsertTextRule
      ],
  },
);
